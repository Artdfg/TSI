...
* myMouseMoouve                                                               *
\*****************************************************************************/
void myMouseMouve(int x, int y)
{
    MouseX = (x - 450) / 900.0f * 3.14f / 2.0f;
    MouseY = (y - 450) / 900.0f * 3.14f / 2.0f;

    angle_x += MouseX;
    angle_y += MouseY;

    cam.tr.rotation_euler = vec3(angle_y, angle_x, 0.0f);
...
int main(int argc, char** argv)
{
    ...
    glutPassiveMotionFunc(myMouseMouve);
